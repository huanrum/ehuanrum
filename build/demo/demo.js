    ...
    $e('router.work.random', ['common_page', 'random', function (common_page, random) {
        ...
        return function (name) {
            var binding = common_page([
                ...
                '       <textarea [value]="item.model" [onkeyup]="random(item)" style="width:300px;height:200px;"></textarea>',
                '       <br>',
                ...
                '</div>'
                    ...
                    items: [
                        ...
                        { model: '{"name":"data-[(0-9)8]","list:3-6":{"id":"[(0-9)1-4]","index":"[0-999]","type":"[(a-Z)3-6]","other[()1-5]":"[()3-7]"}}', info: '对象(里面带有数组)' },
